...
<?php include 'part/header.php'; ?>
      <div class="content virtual virtual-greyhounds">
                  ...
                  <div class="panel-body">
                    <div class="tab-content">
                      <div class="tab-pane fade in active" id="tab1default">                
                        <iframe frameborder="0" allowtransparency="true" name="vfl_iframe" id="vfl_iframe" width="" height="520px" scrolling="no" src="https://www.betadonis.com//vfl30/vleague.php?clientid=1609&lang=en&style=betadonis"></iframe>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="virtual-bets-container greyhounds" >
                ...
                <div class="tab-content">
                    <div class="tab-pane active fade in" id="tab1">
                        ...
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-1.php'; ?>
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-1.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-1.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-1.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-1.php'; ?>             
                    ...
                    <div class="tab-pane fade" id="tab2">
                        ...
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-2.php'; ?>
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-2.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-2.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-2.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-2.php'; ?>             
                    ...
                    <div class="tab-pane fade" id="tab3"> 
                        ...
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-3.php'; ?>
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-3.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-3.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-3.php'; ?>             
                        <?php include 'part/virtual-part/virtual-bets-greyhounds-3.php'; ?>             
